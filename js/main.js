...
const baskertEl = basketStarterEl.querySelector(".basket");

basketStarterEl.addEventListener("click",function(e){
    e.stopPropagation();
    if(baskertEl.classList.contains("show")){
        hideBasket()
    } else{
        showBasket()
    }
...
baskertEl.addEventListener("click", function(e){
    e.stopPropagation();
})
...
function showBasket(){
    baskertEl.classList.add("show")
}
function hideBasket(){
    baskertEl.classList.remove("show")
}
// 검색!
